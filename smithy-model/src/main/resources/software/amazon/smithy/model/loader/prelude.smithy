...
/// Defines a proper name for a service, resource, or enum member.
///
/// This title can be used in automatically generated documentation
/// and other contexts to provide a user friendly name for shapes.
@trait(selector: ":is(:not(member), member :test(< :is(enum, intEnum)))")
string title
